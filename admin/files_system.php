...
<head>
    ...
    <title>Files on the system | XFILESControl Cloud</title>
                ...
                <div class="grid-columns">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
							...
							$query = mysqli_query($conn, "SELECT * FROM storage s JOIN employee stu ON s.employee_id=stu.employee_id") or die(mysqli_error());
